...
<meta name="apple-itunes-app" content="app-id=1112148892, app-argument={{CSR_ROOT}}{{$_SERVER['REQUEST_URI']}}">
<meta property="og:url" content="{{CSR_ROOT}}{{$_SERVER['REQUEST_URI']}}" />
