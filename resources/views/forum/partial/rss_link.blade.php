<div class="rss-link input-group mt-4" title="Houd deze url privé!&#013;Nieuwe aanvragen: zie je profiel">
	...
	@if(CsrDelft\model\security\LoginModel::getUid() == \CsrDelft\model\security\LoginModel::UID_EXTERN || CsrDelft\model\security\LoginModel::getAccount()->hasPrivateToken())
