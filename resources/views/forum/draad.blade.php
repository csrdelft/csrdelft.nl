				...
				@if($draad->magMeldingKrijgen())
					<div class="btn-group mr-2">
						<a href="/forum/meldingsniveau/{{$draad->draad_id}}/nooit"
							 class="btn btn-light post ReloadPage melding-nooit @if(\CsrDelft\entity\forum\ForumDraadMeldingNiveau::isNOOIT($draad->getMeldingsNiveau())) active @endif"
							 title="Nooit meldingen ontvangen">@icon('email_delete', 'email_delete')</a>
						<a href="/forum/meldingsniveau/{{$draad->draad_id}}/vermelding"
							 class="btn btn-light post ReloadPage melding-vermelding @if(\CsrDelft\entity\forum\ForumDraadMeldingNiveau::isVERMELDING($draad->getMeldingsNiveau())) active @endif"
						...
						<a href="/forum/meldingsniveau/{{$draad->draad_id}}/altijd"
							 class="btn btn-light post ReloadPage melding-altijd @if(\CsrDelft\entity\forum\ForumDraadMeldingNiveau::isALTIJD($draad->getMeldingsNiveau())) active @endif"
