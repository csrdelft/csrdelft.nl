		...
		<section id="one" class="wrapper kleur1">
			<div class="inner">
				...
				<div class="content">
					...
					<p style="color:red;"><em>Vanwege de recente maatregelen omtrent de verspreiding van het coronavirus, is besloten per direct alle verenigingsactiviteiten af te gelasten en is onze sociëteit gesloten. Als u hierover vragen heeft of het bestuur wil bereiken kunt u het bestuur mailen (bestuur@csrdelft.nl).</em></p>
