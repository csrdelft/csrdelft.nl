...
@section('content')
	...
	<p>
		...
		Als u bent ingedeeld voor een corveetaak staat dat aangegeven door middel van dit icoon: @icon("paintcan", null, "Corvee")
	...
	<table id="maalcie-tabel" class="maalcie-tabel">
		...
		<tr>
			...
			<th>Gasten</th>
			<th title="Gasten allergie/diëet" style="width: 25px;">@icon("comment")</th>
		</tr>
		</thead>
		<tbody>
		@foreach($maaltijden as $mid => $maaltijd)
			@include('maaltijden.maaltijd.mijn_maaltijd_lijst', ['maaltijd' => $maaltijd, 'standaardprijs' => $standaardprijs, 'aanmelding' => $aanmeldingen[$mid]])
		@endforeach
		</tbody>
	</table>
