...
De ontmoetingsplek bij uitstek is de maaltijden. 
Twee keer per week wordt in de keuken van Confide door leden een goede goedkope maaltijd geserveerd. 
...
In januari is de Dies Natalis, de verjaardag van de vereniging, dit is een week met activiteiten afgesloten met de climax: het gala.');
...
'<h1>Confide</h1>
<div class="fotoachtergrond"><img src="fotos/confide.jpg" alt="Soci&euml;teit Confide" /></div>
...
'<h1>Lid worden</h1>
Je kunt lid worden van C.S.R. wanneer je een universitaire of HBO-opleiding volgt. Als je besloten hebt om lid te worden bij C.S.R. zal de Novitiaats-Commissie ervoor zorgen dat je je thuis gaat voelen bij onze vereniging. Deze Commissie bestaat uit ouderejaars die je een half jaar lang alle <em>ins en outs</em> van C.S.R. laten zien.<br />
Na de OWee (OntvangstWeek) is er een kennismakingsweek waarbij je verplicht aanwezig moet zijn.
<p />
Ook als je nu al weet dat je bij C.S.R. lid wil worden kun je je het beste inschrijven <!--<a href="programma.php">-->tijdens de Owee in ons pand<!--</a>-->, dus kom zeker een keertje langs, of vul het formulier hieronder in, dan nemen wij contact met je op.
<p />
...
We zijn enthousiast over de bijbel, Jezus en de dingen die God voor ons in petto heeft. Christen zijn is voor ons dan ook niet enkel een formaliteit. We hebben één keer per twee weken een <em>bijbelkring</em>; deze bestaan uit kleine groepen  van zes tot tien personen. En we hebben werkgroepen die je kunt volgen als je wilt. Hier wordt een bepaald onderwerp behandeld of een activiteit georganiseerd. Eens in de maand wordt er een lezing georganiseerd. Een gastspreker vertelt over een interessant onderwerp. 
');
...
<p />
<div class="fotoachtergrond"><img src="fotos/07-salsaworkshop2.jpg" alt="Dansen op de salsa workshop" /></div>
<strong>Salsaworkshop</strong><br />
<div class="fotoachtergrond"><img src="fotos/07-startkamp2006.jpg"  alt="Een dienst tijdens startkamp" /></div>
<strong>Dienst tijdens startkamp</strong><br />
<div class="fotoachtergrond"><img src="fotos/07-bbq3.jpg"  alt="Voetbal kijken!" /></div>
<strong>Openingsactiviteit lustrumjaar: BBQ\'en en WK-voetbal kijken</strong><br />
<div class="fotoachtergrond"><img src="fotos/07-beaufort.jpg" alt="In de boot met ondervereninging \'Beaufort\'" /></div>
<strong>Zeilen met ondervereniging \'Beaufort\'</strong><br />
<div class="fotoachtergrond"><img src="fotos/07-predikantenborrel.jpg" alt="Interessante gespreken op de predikantenborrel" /></div>
<strong>Predikantenborrel</strong><br />
<div class="fotoachtergrond"><img src="fotos/07-lezing.jpg" alt="Een lezing in de achterzaal" /></div>
<strong>Lezing</strong><br />
<div class="fotoachtergrond"><img src="fotos/07-wortelweekend.jpg" alt="Kamperen tijdens een jaarweekend" /></div>
<strong>Een weekendje weg met je jaargenoten</strong><br />
<div class="fotoachtergrond"><img src="fotos/07-praag1.jpg" alt="Relaxen op de kade in Praag" /></div>
<strong>Lustrumreis naar Praag</strong><br />

 <!--Voor meer foto\'s, klik <a  href="">hier</a>.<br />-->
');
/*
<strong> </strong><br />
<div class="fotoachtergrond"><img src="fotos/ .jpg" alt=" " /></div>
*/

// achter 'vaardigheden.': Daarnaast is het gewoon onwijs leuk om iets neer te zetten wat jij organiseert.
...
'<h1>Organisatie</h1>Ervaring kun je opdoen met commissie- en/of bestuurswerk. Dit is erg handig voor het werk dat je na je studie gaat doen, maar ook goed voor de onderlinge band en je communicatieve vaardigheden.<br />

Het bestuur van C.S.R. bestaat uit vijf leden van de vereniging. Daarnaast zijn er tal van commissies, vari&euml;rend van de BarCommissie tot de AlmanakCommissie.');
...
Voor een diepgaander verhaal over C.S.R. kan je terecht op <a href="http://csrdelft.nl/vereniging/">de website</a>.', true);
...
<body>
	...
	<div id="logo">
		<a href="index.php" onmouseover="return overlib(\'Terug naar het begin\', CSSW3C);" onmouseout="return nd();">
			<img src="plaatjes/logo_klein.gif" id="logoKlein" alt="Terug naar het begin" />
		</a>
	</div>
<?php
