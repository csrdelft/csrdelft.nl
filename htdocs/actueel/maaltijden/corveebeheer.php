...
if(isset($_POST['koks'], $_POST['afwassers'], $_POST['theedoeken'], $_POST['punten_kok'], $_POST['punten_afwas'],
	$_POST['punten_theedoek'])){
	$maalid=(int)$_POST['maalid'];
	$actie=(int)$_POST['actie'];

	# bestaande maaltijd bewerken
	if($actie == 'bewerk' && ($maaltrack->editCorveeMaaltijd($maalid, $_POST['koks'], $_POST['afwassers'], $_POST['theedoeken'], $_POST['punten_kok'], $_POST['punten_afwas'], $_POST['punten_theedoek']))){
		header('location: '.CSR_ROOT.'actueel/maaltijden/corveebeheer/bewerk/'.$maalid);
		exit;
	} elseif ($actie == 'takenbewerk' && ($maaltrack->editCorveeMaaltijdTaken($maalid, $_POST['kok'], $_POST['afwas'], $_POST['theedoek']))){
