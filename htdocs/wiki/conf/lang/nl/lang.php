...
$lang['txt_filename']          = 'Vul nieuwe naam in (optioneel)(Voor de vormingsbank de bestandsnaam beginnen met werkgroepnaam)<br />';
...
$lang['mediaroot']             = 'root';
$lang['mediaupload']           = '<ul><li>Upload hier een bestand naar de huidige namespace.</li> <li>Om een subnamespace aan te maken, zet je de naam van die namespace voor de bestandsnaam bij het invulvakje, gescheiden door een dubbele punt. Bijvoorbeeld: <i>weekeindcie:bestandsnaam.pdf</i></li> <li>Upload bij voorkeur bestanden in <b>.pdf-formaat</b>. Vooral .doc/.docx/etc openen lastiger in ander programma\'s en verliezen dan opmaak.</li></ul>';
