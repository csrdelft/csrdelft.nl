...
$form['lidworden']['referer']      = 'http://pubcie.csrdelft.nl/informatie/lidworden.php';
$form['lidworden']['submit_to']    = 'pubcie@csrdelft.nl';
...
$form['lidworden']['ok_url']       = 'http://pubcie.csrdelft.nl/informatie/lidworden.php?a=ok';
