 ...
 * 
 * Entry point voor instellingen-beheer module.
 * 
 */
try {
	require_once 'configuratie.include.php';
	require_once 'MVC/controller/InstellingenBeheerController.class.php';

	$query = filter_input(INPUT_GET, 'uri', FILTER_SANITIZE_URL);
	$controller = new InstellingenBeheerController($query);
