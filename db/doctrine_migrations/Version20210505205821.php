...
(
    ...
    COLLATION_NAME != 'utf8mb4_general_ci'
		...
		$queries = $this->connection->prepare("
SELECT CONCAT('ALTER TABLE `', table_name, '` MODIFY `', column_name, '` ', COLUMN_TYPE, ' CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci', (CASE WHEN IS_NULLABLE = 'NO' THEN ' NOT NULL' ELSE '' END), ';')
FROM information_schema.COLUMNS
WHERE TABLE_SCHEMA = '{$databaseName}'
AND DATA_TYPE != 'varchar'
AND
