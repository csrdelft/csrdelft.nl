...
final class Version20201018101438 extends AbstractMigration {
	public function getDescription(): string {
		return 'Voeg tabellen voor digitale declaraties toe';
	}
	...
	public function up(Schema $schema): void {
		...
		$this->addSql('CREATE TABLE declaratie_bon (id INT AUTO_INCREMENT NOT NULL, declaratie_id INT DEFAULT NULL, bestand VARCHAR(255) NOT NULL, datum DATETIME DEFAULT NULL, INDEX IDX_5879E79D6AE7FC36 (declaratie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
		$this->addSql('CREATE TABLE declaratie_categorie (id INT AUTO_INCREMENT NOT NULL, wachtrij_id INT NOT NULL, naam VARCHAR(255) NOT NULL, INDEX IDX_F1F5C1F8E32FD936 (wachtrij_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
		...
		$this->addSql('CREATE TABLE declaratie_wachtrij (id INT AUTO_INCREMENT NOT NULL, naam VARCHAR(255) NOT NULL, rechten VARCHAR(255) NOT NULL, positie INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
