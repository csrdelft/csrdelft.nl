...
final class Version20201229163542 extends AbstractMigration {
	...
	public function up(Schema $schema): void {
		...
		$this->addSql('CREATE TABLE civimelder_deelnemer (id INT AUTO_INCREMENT NOT NULL, activiteit_id INT NOT NULL, aantal INT NOT NULL, aangemeld DATETIME NOT NULL, INDEX IDX_6BC8A6B85A8A0A1 (activiteit_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
