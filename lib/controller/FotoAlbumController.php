...
class FotoAlbumController extends AbstractController
{
	 ...
	 */
	public function toevoegen(Request $request, $dir): JsonResponse|FotoAlbumToevoegenForm
	{
	 ...
	 * @Auth({P_ALBUM_ADD,P_ALBUM_PUBLIC_ADD})
	 */
	public function uploaden(Request $request, $dir): JsonResponse|RedirectResponse|Response
	{
		$album = $this->fotoAlbumRepository->getFotoAlbum($dir);
	 ...
	 */
	public function downloaden($dir): void
	{
		$album = $this->fotoAlbumRepository->getFotoAlbum($dir);
	 ...
	 * @Auth(P_LEDEN_READ)
	 */
	public function addtag(Request $request, $dir): JsonResponse|FotoTagToevoegenForm
	{
		$album = $this->fotoAlbumRepository->getFotoAlbum($dir);
	...
	private function assertValidFotoPath($dir, $foto): void
	{
