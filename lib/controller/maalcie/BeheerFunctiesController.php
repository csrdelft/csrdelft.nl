...
class BeheerFunctiesController extends AbstractController
{
	 ...
	 * @Auth(P_CORVEE_MOD)
	 */
	public function toevoegen(): Response|FunctieForm
	{
	 ...
	 * @Auth(P_CORVEE_MOD)
	 */
	public function bewerken(CorveeFunctie $functie): Response|FunctieForm
	{
	 ...
	 * @Auth(P_CORVEE_MOD)
	 */
	public function kwalificeer(CorveeFunctie $functie): Response|KwalificatieForm
	{
