...
class LedenlijstContent implements View {
	...
	public function view() {
		if ($this->lidzoeker->count() > 0) {
			...
			echo '<a href="' . $url . '" class="btn float-right" title="Huidige selectie exporteren naar Google Contacts" onclick="return confirm(\'Weet u zeker dat u deze ' . $this->lidzoeker->count() . ' leden wilt importeren in uw Google-contacts?\')"><img src="/plaetjes/knopjes/google.ico" width="16" height="16" alt="toevoegen aan Google contacts" /></a>';
		}
		echo getMelding();
