...
class SessionsData extends DataTableResponse {
	...
	public function getJson($sessie) {
		...
		$array['details'] = '<a href="/endsession/' . $array['session_id'] . '" class="post DataTableResponse remove" title="Log uit"><img width="16" height="16" class="icon" src="//csrdelft.nl/plaetjes/famfamfam/door_in.png"></a>';
