...
abstract class InputField implements FormElement, Validator {
	...
	public function getLabel() {
		if (!empty($this->description)) {
			...
			$help = '';
			if ($this->title) {
				$help = '<div class="help" onclick="confirm(\'' . addslashes($this->title) . '\');"><img width="16" height="16" class="icon hoverIntentContent" alt="?" src="/plaetjes/famfamfam/help.png"></div>';
			}
