...
class TextField extends InputField
{
	 ...
	 *
	 * @psalm-param list{0: 'type', 1: 'id', 2: 'class'|'name', 3: 'class'|'disabled', 4: 'readonly'|'value', 5: 'maxlength'|'origvalue', 6: 'disabled'|'placeholder', 7: 'autocomplete'|'readonly', 8?: 'maxlength', 9?: 'placeholder', 10?: 'autocomplete'} $attribute
	 */
