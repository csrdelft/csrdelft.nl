...
class Voorpagina
{
	...
	public function getFotoalbum(): ?string
	{
		...
		if ($album !== null) {
			return $this->twig->render('voorpagina/fotoalbum.html.twig', [
				'album' => $album,
	...
	public function getAgenda(): ?string
	{
		...
		if (LoginService::mag(P_AGENDA_READ)) {
			...
			return $this->twig->render('voorpagina/agenda.html.twig', [
				'items' => $groups,
			]);
		}
	...
	private function blockForumNieuwsteBelangrijkBerichten()
	{
		...
		if (lid_instelling('zijbalk', 'forum_belangrijk') > 0) {
			return $this->twig->render('voorpagina.html.twig', [
				'draden' => $this->forumDradenRepository->getRecenteForumDraden(
