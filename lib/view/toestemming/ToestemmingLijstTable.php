...
class ToestemmingLijstTable extends DataTable
{
	public function __construct($extrakolommen = [])
	{
		...
		$bronKnop = new CollectionDataTableKnop(
			Multiplicity::None(),
			'Selectie',
			'Maak een bron selectie'
		);
		$bronKnop->addKnop(
			new SourceChangeDataTableKnop(
				'/toestemming/lijst',
				'Leden',
				'Alle leden en novieten'
			)
		);
		$bronKnop->addKnop(
			new SourceChangeDataTableKnop(
				'/toestemming/lijst?filter=oudleden',
				'Oudleden',
				'Alle oudleden'
			)
		);
		$bronKnop->addKnop(
			new SourceChangeDataTableKnop(
				'/toestemming/lijst?filter=ledenoudleden',
				'Leden & oudleden',
				'Alle leden en oudleden'
			)
		);
		$bronKnop->addKnop(
			new SourceChangeDataTableKnop(
				'/toestemming/lijst?filter=iedereen',
				'Iedereen',
