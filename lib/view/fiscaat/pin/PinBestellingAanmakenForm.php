...
class PinBestellingAanmakenForm extends ModalForm
{
	...
	public function __construct($pinTransactieMatch = null)
	{
		...
		$fields[] = new HtmlComment(
			'Er is geen bestelling gevonden voor deze transactie. Maak met onderstaand formulier een nieuwe bestelling aan met het aangegeven bedrag.'
		);
		...
		$fields['intern'] = new TextareaField(
			'intern',
			$pinTransactieMatch ? $pinTransactieMatch->notitie : null,
			'Interne notitie'
		);
		...
		$fields['pinTransactieId'] = new RequiredIntField(
			'pinTransactieId',
