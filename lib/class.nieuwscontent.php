...
class NieuwsContent extends SimpleHTML {
	...
	private function getBerichtModControls($iBerichtID){
		if($this->_nieuws->isNieuwsMod()){
			return ' [&nbsp;<a href="'.NIEUWS_ROOT.'verwijderen/'.$iBerichtID.'" onclick="return confirm(\'Weet u zeker dat u dit nieuwsbericht wilt verwijderen?\')">verwijderen</a>&nbsp;|&nbsp;<a href="'.NIEUWS_ROOT.'bewerken/'.$iBerichtID.'">bewerken</a>&nbsp;]';
		}
	}
