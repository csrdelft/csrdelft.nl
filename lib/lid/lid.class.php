	...
	public function getNaamLink($vorm='full', $mode='plain'){
		...
		if (($mode === 'visitekaartje' || $mode === 'link') && LoginLid::instance()->hasPermission('P_LEDEN_READ')) {
			...
			if ($mode === 'visitekaartje' && Instelling::get('layout_visitekaartjes') == 'ja') {
				...
				$k.= '<div class="envelop"><a href="https://www.google.nl/search?q='.$kleur.'+envelop+briefpapier" target="_blank" title="Nu direct '.$kleur.' envelop & briefpapier regelen!"><img src="'.CSR_PICS.'layout/'.$kleur.'_envelop.png" alt="env"></a></div>';
