...
class LidInstellingen extends PersistenceModel {
	...
	private $instellingen = array(
		...
		'layout'		 => array(
			'layout'		 => array('Websteklayout', T::Enumeration, array('normaal', 'owee', 'lustrum', 'sineregno', 'roze'), 'owee'),
		...
		'forum'			 => array(
			...
			'afbeeldingHover'		 => array('Toon groter formaat afbeeldingen', T::Enumeration, array('nee', 'hoverIntent'), 'nee')
		),
		'zijbalk'		 => array(
