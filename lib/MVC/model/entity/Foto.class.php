...
class Foto extends Afbeelding {
	...
	public function createThumb() {
		...
		$command = IMAGEMAGICK_PATH . 'convert ' . escapeshellarg($this->getFullPath()) . ' -thumbnail 150x150 -gravity center -crop 150x150+0+0 +repage -format jpg -quality 80 ' . $rotate . escapeshellarg($this->getThumbPath());
