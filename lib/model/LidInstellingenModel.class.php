...
class LidInstellingenModel extends InstellingenModel {
	...
	protected static $defaults = [
		...
		'zijbalk' => [
			'ishetal' => ['Is het al… weergeven', T::Enumeration, ['niet weergeven', 'willekeurig', 'wist u dat', 'weekend', 'kring', 'lezing', 'borrel', 'jarig', 'dies', 'ontbijt', 'lunch', 'avondeten', 'studeren', 'foutmelding', 'sponsorkliks', 'patronaat', 'patroon'], 'willekeurig', ''],
