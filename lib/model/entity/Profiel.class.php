...
class Profiel extends PersistentEntity implements Agendeerbaar {
	...
	public function getLink($vorm = 'civitas') {
		...
		$l = '<a href="/profiel/' . $this->uid . '" title="' . htmlspecialchars($this->getNaam('volledig')) . ' (klik om ' . $geslacht . ' profiel te bekijken)" class="lidLink ' . htmlspecialchars($this->status) . '">';
