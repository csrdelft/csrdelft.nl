...
class CorveevoorkeurenLijst{
	...
	private function getCorveeLeden($sort='achternaam'){
		$zoekLeden = Zoeker::zoekLeden('', 'uid', 'alle', $sort, array('S_LID', 'S_NOVIET', 'S_GASTLID'), array('uid', 'achternaam', 'voornaam', 'tussenvoegsel', 'corvee_voorkeuren', 'corvee_vrijstelling', 'corvee_punten_totaal'));
		$bewerkteLeden = array();
	...
	public function getCorveeLedenGesorteerd($sorteer, $sorteer_richting){
		$sorteer_toegestaan = array('achternaam', 'voorkeur_0', 'voorkeur_1', 'voorkeur_2', 'voorkeur_3', 'voorkeur_4', 'voorkeur_5', 'voorkeur_6', 'voorkeur_7', 'voorkeur_8', 'voorkeur_9', 'corvee_kwalikok', 'corvee_punten_totaal', 'corvee_punten_bonus', 'corvee_vrijstelling', 'corvee_prognose', 'corvee_tekort');
		...
		$sorteer_meteen = array('achternaam', 'corvee_kwalikok', 'corvee_punten_totaal', 'corvee_punten', 'corvee_punten_bonus', 'corvee_vrijstelling');
		$sorteer_achteraf = array('corvee_prognose', 'corvee_tekort', 'voorkeur_0', 'voorkeur_1', 'voorkeur_2', 'voorkeur_3', 'voorkeur_4', 'voorkeur_5', 'voorkeur_6', 'voorkeur_7', 'voorkeur_8', 'voorkeur_9');
		
		//Bepaal met welke sortering de lijst opgehaald moet worden
		$sortering = 'corvee_punten_totaal desc';
		if(in_array($sorteer, $sorteer_meteen)){
			$sortering = $sorteer.' '.$sorteer_richting;
			$sortering = $sortering.', corvee_punten_totaal DESC';
		}
		...
		if(in_array($sorteer, $sorteer_achteraf)){
			...
			$sorteer_op_voorkeur = array('voorkeur_0', 'voorkeur_1', 'voorkeur_2', 'voorkeur_3', 'voorkeur_4', 'voorkeur_5', 'voorkeur_6', 'voorkeur_7', 'voorkeur_8', 'voorkeur_9');
