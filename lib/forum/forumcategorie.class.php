...
class ForumCategorie{
	...
	public function magBekijken(){		return LoginLid::mag($this->getRechten_read()); }
	...
	public function magPosten(){ 		return LoginLid::mag($this->getRechten_post()); }
	...
	public static function existsVoorUser($iCatID){
		...
		if($categorie->getID()!=0){
			return LoginLid::mag($categorie->getRechten_read());
		}
		return false;
	}
