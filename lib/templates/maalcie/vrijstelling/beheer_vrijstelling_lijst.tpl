...
<tr id="vrijstelling-row-{$vrijstelling->uid}">
	<td>
		<a href="/corvee/vrijstellingen/bewerk/{$vrijstelling->uid}" title="Vrijstelling wijzigen" class="btn post popup">{icon get="pencil"}</a>
	</td>
	...
	<td class="col-del">
		<a href="/corvee/vrijstellingen/verwijder/{$vrijstelling->uid}" title="Vrijstelling definitief verwijderen" class="btn post confirm">{icon get="cross"}</a>
	</td>
</tr>
