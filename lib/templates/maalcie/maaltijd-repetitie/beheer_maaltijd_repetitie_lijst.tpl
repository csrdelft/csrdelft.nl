...
<tr id="repetitie-row-{$repetitie->mlt_repetitie_id}">
	<td>{strip}
		<a href="{$smarty.const.maalcieUrl}/bewerk/{$repetitie->mlt_repetitie_id}" title="Maaltijdrepetitie wijzigen" class="btn post popup">{icon get="pencil"}</a>
		<a href="/corveerepetities/maaltijd/{$repetitie->mlt_repetitie_id}" title="Corveebeheer maaltijdrepetitie" class="btn popup">{icon get="chart_organisation"}</a>
	</td>{/strip}
	...
	<td class="col-del"><a href="{$smarty.const.maalcieUrl}/verwijder/{$repetitie->mlt_repetitie_id}" title="Maaltijdrepetitie definitief verwijderen" class="btn post confirm">{icon get="cross"}</a></td>
</tr>