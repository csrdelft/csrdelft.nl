...
{/if}
	...
	<td class="col-del"><a href="{$smarty.const.maalcieUrl}/verwijder/{$repetitie->getCorveeRepetitieId()}" title="Corveerepetitie definitief verwijderen" class="btn rounded post confirm">{icon get="cross"}</a></td>
</tr>