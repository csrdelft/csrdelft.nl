...
<div class="float-right">
	<a href="{$smarty.const.maalcieUrl}/nieuw{if isset($maaltijdrepetitie)}/{$maaltijdrepetitie->getMaaltijdRepetitieId()}{/if}" title="Nieuwe repetitie" class="btn post modal">{icon get="add"} Nieuwe repetitie</a>
</div>
