...
<div class="float-right">
	<a href="{$smarty.const.maalcieUrl}/nieuw{if isset($maaltijdrepetitie)}/{$maaltijdrepetitie->getMaaltijdRepetitieId()}{/if}" title="Nieuwe repetitie" class="btn post popup">{icon get="add"} Nieuwe repetitie</a>
</div>
