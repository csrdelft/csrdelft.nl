...
<div class="float-right">
	<a href="{maalcieUrl}/nieuw{if isset($maaltijdrepetitie)}/{$maaltijdrepetitie->getMaaltijdRepetitieId()}{/if}" title="Nieuwe repetitie" class="knop post modal">{icon get="add"} Nieuwe repetitie</a>
</div>
