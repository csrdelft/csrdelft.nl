...
<form action="{maalcieUrl}/novieten" method="post" class="Formulier modal SubmitReset float-right">
...
</div><select name="toon" onchange="location.href='{maalcieUrl}/'+this.value;">
