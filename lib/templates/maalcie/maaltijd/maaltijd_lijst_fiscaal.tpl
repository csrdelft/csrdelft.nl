...
<html>
	<head>
		<title>{$maaltijd->datum|date_format:"%Y-%m-%d"} {$maaltijd->tijd|date_format:"%H:%M"}</title>
	...
	<body style="font-family: Verdana, Geneva, Arial, Helvetica, sans-serif; font-size: 12px; margin-left: 250px;" onload="selectText(document.getElementById('lijst'));">
