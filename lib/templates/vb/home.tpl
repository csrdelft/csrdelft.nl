<table width = "100%" cellspacing="10px">
	<tr>
		<td width = "50%">
			...
			{$search}
			<br/>
			...of <a href="index.php?actie=theme">klik</a> hier voor een overzicht van alle onderwerpen
			<br/>
			<br/>
...
staat zijn de volgende stappen te zetten op de snelweg 
van vooruitgang is het nodig een beeld te
...
houding tenopzichte van, leiden tot vorming. Vorming, 
een prachtige begrip dat niets meer betekent dan
kennis vergaren. Iets dat we doen vanaf het 
allereerste ogenblik, die momenten vlak voordat u in huilen
...
geestelijke en de academische, vindt u in deze vormingsbank de resultaten. Vervolgens biedt deze digitale
omgeving u de mogelijkheid om interessante oude
koeien uit de sloot te halen om deze met nieuwe
bronnen en materialen opnieuw te belichten. Uiteraard wordt u niet tegengehouden als u zelf
