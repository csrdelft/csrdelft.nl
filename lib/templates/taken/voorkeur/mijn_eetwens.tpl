...
<div id="eetwens" style="display: inline-block; min-width: 250px; vertical-align: top;">
	<div class="inline-edit" onclick="taken_toggle_hiddenform(this);$('#eetwens-field').focus();">{$eetwens|truncate:50:"...":true}&nbsp;</div>
	<form method="post" action="{$globals.taken_module}/eetwens" class="Formulier taken-hidden-form taken-subform">
