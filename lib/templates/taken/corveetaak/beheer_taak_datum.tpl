...
*}
{strip}
<tr id="taak-datum-summery-{$datum}" class="taak-datum-{$datum}{if strtotime($datum) < strtotime('-1 day')} taak-oud{/if}"{if isset($show)} style="display: none;"{/if} onclick="toggle_taken_datum('{$datum}');">
