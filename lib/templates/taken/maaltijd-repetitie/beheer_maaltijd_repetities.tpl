...
<div style="float: right;"><a href="{Instellingen::instance()->('taken', 'url')}/nieuw" title="Nieuwe repetitie" class="knop post popup">{icon get="add"} Nieuwe repetitie</a></div>
...
{foreach from=$repetities item=repetitie}
	{include file='taken/maaltijd-repetitie/beheer_maaltijd_repetitie_lijst.tpl' repetitie=$repetitie}
{/foreach}
	</tbody>
</table>