...
<tr id="repetitie-row-{$repetitie->getCorveeRepetitieId()}">
	<td>{strip}
		<a href="{Instellingen::instance()->('taken', 'url')}/bewerk/{$repetitie->getCorveeRepetitieId()}" title="Corveerepetitie wijzigen" class="knop post popup">{icon get="pencil"}</a>
...
{if !isset($maaltijdrepetitie) and $repetitie->getMaaltijdRepetitieId()}
		<a href="{Instellingen::instance()->('taken', 'url')}/maaltijd/{$repetitie->getMaaltijdRepetitieId()}" title="Corveebeheer maaltijdrepetitie" class="knop">{icon get="calendar_link"}</a>
{/if}
	</td>{/strip}
	...
	<td class="col-del"><a href="{Instellingen::instance()->('taken', 'url')}/verwijder/{$repetitie->getCorveeRepetitieId()}" title="Corveerepetitie definitief verwijderen" class="knop post confirm">{icon get="cross"}</a></td>
</tr>