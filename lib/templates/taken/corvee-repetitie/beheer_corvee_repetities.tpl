...
<a href="/maaltijdenrepetities/beheer/{$maaltijdrepetitie->getMaaltijdRepetitieId()}" title="Wijzig gekoppelde maaltijd" class="knop popup">{icon get="calendar_edit"}</a>
</p><p>
{else}.
{/if}
...
<div style="float: right;">
	<a href="{Instellingen::instance()->('taken', 'url')}/nieuw{if isset($maaltijdrepetitie)}/{$maaltijdrepetitie->getMaaltijdRepetitieId()}{/if}" title="Nieuwe repetitie" class="knop post popup">{icon get="add"} Nieuwe repetitie</a>
</div>
...
{foreach from=$repetities item=repetitie}
	{include file='taken/corvee-repetitie/beheer_corvee_repetitie_lijst.tpl' repetitie=$repetitie}
{/foreach}
	</tbody>
</table>