{*
	taken_htdoc.tpl	|	P.W.G. Brussee (brussee@live.nl)
*}
...
<div id="taken-menu">
	<ul class="horizontal">
		...
		<li{if $globals.taken_module === $globals.taken_htdoc|cat:$link} class="active"{/if}>
...
{if $loginlid->hasPermission('P_MAAL_MOD')}
	...
	<div class="item{if !$prullenbak and $globals.taken_module === $globals.taken_htdoc|cat:$link} active{/if}">»
	...
	<div class="item{if $globals.taken_module === $globals.taken_htdoc|cat:$link} active{/if}">»
