...
{if !$maaltijd->getIsGesloten()}
	...
	&nbsp;<button onclick="if(confirm('Weet u zeker dat u deze maaltijd wil sluiten?'))taken_ajax(this, '/actueel/taken/maaltijden/sluit/{$maaltijd->getMaaltijdId()}', page_reload);">Nu sluiten!</button>
	{/if}
	</h2>
{/if}
