...
<div style="float: right;">
	...
	<a href="{Instellingen::instance()->('taken', 'url')}/nieuw" title="Nieuwe maaltijd" class="knop post popup">{icon get="add"} Nieuwe maaltijd</a>
</div>
<form method="post" action="{Instellingen::instance()->('taken', 'url')}/nieuw" class="Formulier popup SubmitReset">
