<form action="/groepen/{$groep->getType()->getNaam()}/{$groep->getId()}/bewerken" method="post" class="Formulier">
	<div id="groepFormulier" class="groepFormulier clear">
		{if $groep->isAdmin() OR $groep->isEigenaar()}
			...
			{/if}
			<br />
			<label for="sbeschrijving"><strong>Korte beschrijving:</strong></label><br />
		...
		{else}
			<br />
			<label for="beschrijving"><strong>Lange beschrijving:</strong></label><br />
		...
		<input type="submit" id="submit" value="Opslaan" class="btn" />
