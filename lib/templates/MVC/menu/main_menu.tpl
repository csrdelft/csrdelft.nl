		...
		<div class="input-group">
			...
			<div class="input-group-btn">
				...
				<ul class="dropdown-menu dropdown-menu-right" role="menu">
					<li><span id="cd-zoek-select" class="glyphicon glyphicon-ok" style="position:absolute;top:10px;left:10px;"></span><a onclick="this.form.submit();">Leden & Groepen</a></li>
					<li class="divider"></li>
					<li><a href="/forum/zoeken/" onclick="this.href += encodeURIComponent($('#cd-zoek-veld').val());">Forum</a></li>
					<li><a href="/wiki/hoofdpagina?do=search&id=" onclick="this.href += encodeURIComponent($('#cd-zoek-veld').val());">Wiki</a></li>
				</ul>
			</div><!-- /btn-group -->
		</div><!-- /input-group -->
