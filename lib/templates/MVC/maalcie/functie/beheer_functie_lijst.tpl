...
<tr id="corveefunctie-row-{$functie->functie_id}">
	<td>
		<a href="{$smarty.const.maalcieUrl}/bewerken/{$functie->functie_id}" title="Functie wijzigen" class="knop rounded post modal">{icon get="pencil"}</a>
	</td>
	...
	<td>
		{if $functie->kwalificatie_benodigd}
			<div class="float-left"><a href="{$smarty.const.maalcieUrl}/kwalificeer/{$functie->functie_id}" title="Kwalificatie toewijzen" class="knop post modal">{icon get="vcard_add"} Kwalificeer</a></div>
		{/if}
		...
		{foreach from=$functie->getKwalificaties() item=kwali}
			<div class="kwali{if LidCache::getLid($kwali->uid)->isOudlid()} verborgen{/if}">
				<a href="{$smarty.const.maalcieUrl}/dekwalificeer/{$functie->functie_id}/{$kwali->uid}" title="Kwalificatie intrekken" class="knop post">{icon get="vcard_delete"}</a>
	...
	<td class="col-del">
		<a href="{$smarty.const.maalcieUrl}/verwijderen/{$functie->functie_id}" title="Functie definitief verwijderen" class="knop rounded post confirm">{icon get="cross"}</a>
	</td>
</tr>