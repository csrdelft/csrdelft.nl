{if LoginModel::mag('P_LOGGED_IN')}
	...
	{if !isset($deel->forum_id) OR (isset($deel->forum_id) AND $deel->magModereren())}
		<div class="forumheadbtn">
			<a href="/forum/wacht" class="btn rounded" title="Reacties die wachten op goedkeuring">{icon get="hourglass"} {ForumPostsModel::instance()->getAantalWachtOpGoedkeuring()}</a>
		</div>
	{/if}
{/if}