...
<section id="wrapper">
    ...
    <section id="two" class="wrapper alt kleur2">
        <div class="inner">
            <span class="image lazy-load" data-lazy="<img src='/assets/layout-owee/plaetjes/podium.jpg' alt=''/>"></span>
            <div class="content">
                ...
                <p>Ter aanvang van elk studiejaar wordt er een OntvangstWeek georganiseerd, ofwel de OWee. Dit jaar
                    duurt de OWee van 21 t/m 25 augustus met op zondag 21 augustus de officiële opening. Tijdens deze
    ...
    <section id="footer">
        <div class="inner">
            ...
            <ul class="contact">
                ...
                <li class="fa-map-marker lazy-load"
                    data-lazy="<iframe src='https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2456.0445350385166!2d4.360246300000008!3d52.0060664!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47c5b5c03dabb5b3%3A0xea6a437036970629!2sOude+Delft+9!5e0!3m2!1sen!2s!4v1404470858468' height='300' frameborder='0' style='border:0'></iframe>">
                </li>
            </ul>
            <ul class="sponsors">
                <li>
