...
{if $boek->getId()==0}
	...
	<div class="boekzoeker" title="Geef titel, auteur, isbn of een ander kenmerk van het boek. Minstens 7 tekens, na 1 seconde verschijnen suggesties.">
		<label for="boekzoeker"><img src="/images/google.ico" width="16" height="16" alt="Zoeken op Google Books" />Google Books:</label><input type="text" placeholder="Zoek en kies een suggestie om de velden te vullen" id="boekzoeker">
	</div>
