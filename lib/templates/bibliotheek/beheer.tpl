...
<ul class="horizontal">
	...
	<li class="active">
		<a href="/communicatie/bibliotheek/beheer" title="Naar de beheeroverzicht">Boekstatus</a>
	</li>
</ul>
...
<div id="filters">
	...
	<a {if $catalogus->getFilter()=='leden'}class="actief"{/if} href="/communicatie/bibliotheek/beheer/leden">Boeken van Leden</a> - 
