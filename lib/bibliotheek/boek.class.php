...
class Boek {
	...
	protected function getCommonFields($naamtitelveld = 'Titel') {
		...
		$fields['auteur']->suggestions[] = '/communicatie/bibliotheek/autocomplete/auteur';
		...
		$fields['taal']->suggestions[] = '/communicatie/bibliotheek/autocomplete/taal';
		...
		$fields['uitgeverij']->suggestions[] = '/communicatie/bibliotheek/autocomplete/uitgeverij';
...
class NieuwBoek extends Boek {
	...
	public function createBoekformulier() {
		...
		if ($this->magBekijken()) {
			...
			$nieuwboekformulier[] = new FormDefaultKnoppen('/communicatie/bibliotheek/');
