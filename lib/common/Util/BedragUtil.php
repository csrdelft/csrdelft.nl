...
final class BedragUtil
{
	 ...
	 */
	public static function format_euro($bedrag): string
	{
	 ...
	 */
	public static function format_bedrag_kaal($bedrag): string
	{
	 ...
	 */
	public static function format_bedrag($bedrag): string
	{
