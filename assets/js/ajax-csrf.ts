...
function getCsrfHeaders(): Token {
	const idMetaTag = document.querySelector<HTMLMetaElement>(
		"meta[property='X-CSRF-ID']"
	);
	const valueMetaTag = document.querySelector<HTMLMetaElement>(
		"meta[property='X-CSRF-VALUE']"
	);
