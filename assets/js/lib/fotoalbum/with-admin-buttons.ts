	...
	class extends constructor {
		...
		constructor(albums: AlbumItem[], params: Params) {
			...
			const container = withTooltip(
				createElement(
					'<span class="j-gallery-icon"><i class="fa fa-wrench"></i></span>'
				),
				{
					style: {
			...
			const rotateClockwiseButton = createElement(
				`<div><i class="fa fa-redo"></i>&nbsp;Draai met de klok mee</div>`,
				{
					style: {
						padding: '0.2em',
					},
			...
			const setCoverButton = createElement(
				`<div><i class="fa fa-folder"></i>&nbsp;Instellen als albumcover</div>`,
				{
					style: {
						padding: '0.2em',
					},
			...
			const deleteButton = createElement(
				`<div><i class="fa fa-times"></i>&nbsp;Verwijderen</div>`,
				{
					style: {
						padding: '0.2em',
					},
